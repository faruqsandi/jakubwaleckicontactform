...
def background_form_submission_task(form_submission_id: int) -> dict[str, Any]:
    """
    Background task for form submission using the actual submission handler.
    ...
    """
    try:
        from contactform.insertion.submission_handler import submit_contact_form
        from contactform.mission.crud import get_db
        ...
        try:
            ...
            submission_result = submit_contact_form(form_submission_id, db)
